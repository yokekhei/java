...
public class OpenWireProducer extends OpenWireClient implements Producer {
	private static final Logger logger = LoggerFactory.getLogger(OpenWireProducer.class);
	
	private CountDownLatch failoverLatch;
	private MessageProducer msgProducer;
	private int count = 0;
	
	public OpenWireProducer(String name, String queueName, AppConfig appConfig) {
