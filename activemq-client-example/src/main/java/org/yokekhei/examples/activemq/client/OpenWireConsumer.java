...
public class OpenWireConsumer extends OpenWireClient implements Consumer {
	private static final Logger logger = LoggerFactory.getLogger(OpenWireConsumer.class);
	
	private CountDownLatch failoverLatch;
	private MessageConsumer msgConsumer;
	private MessageListener messageListener;
	
	public OpenWireConsumer(String name, String queueName, AppConfig appConfig) {
